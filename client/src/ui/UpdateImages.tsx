      ...
      <div className="fixed left-2/4 top-2/4 z-50 h-[620px] w-[540px] -translate-x-2/4 -translate-y-2/4 bg-white px-10 py-7 shadow-md">
        <form className="h-full" onSubmit={handleOnSubmit}>
          ...
          >
            ...
            <div
              className={
                "flex h-[400px] items-center justify-center rounded border border-dashed" +
                (type === "image"
            ...
            <button
              type="submit"
              disabled={typeof acceptedFiles[0] === "undefined"}
              className={
            ...
            >
              {loadingArticle ? <SpinnerMini /> : "Add New Image"}
            </button>
          </div>
        </form>
      </div>
