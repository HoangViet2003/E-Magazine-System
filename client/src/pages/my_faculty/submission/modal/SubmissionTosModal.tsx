...
export default function SubmissionTosModal({
  isAccepted,
  setIsAccepted,
  ...
  return (
    <dialog id="terms_and_conditions" className="modal">
      <div className="modal-box max-w-[1100px] px-11 py-9">
        <h3 className="mb-4 text-2xl font-semibold text-[#004AD7]">
          Terms and Conditions
        </h3>

        <h4 className="mb-4 text-lg font-semibold text-[#132F41]">
          Your Agreement
        </h4>
        <div className="h-[400px] overflow-scroll overflow-x-hidden">
          <p>Last Revised: April 1, 2024</p>
          <p>
          ...
          <p>
            ...
            property infringment. We will promptly process and investigate
            notices of alleged
          </p>
          ...
          <p>
            ...
            property laws. Notices of claimed infringement should be directed
            to:
            <br />
        ...
        <div className="flex items-center justify-between">
          <label className="label mt-5 cursor-pointer gap-4">
            <input
              type="checkbox"
              ...
              checked={isAccepted}
            />
            <span className="label-text text-base font-medium text-[#000]">
